...
Route::get('/pelanggan/export', [PelangganController::class,'export_excel'])->middleware(['auth']);
...
Route::get('/{id}-tagihan-{bulan}/export', [TagihanController::class, 'export_excel'])->middleware(['auth']);
