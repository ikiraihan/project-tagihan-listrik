            ...
            <div class="row justify">
                <div class="col-xl-20 col-lg-12 col-md-9">
                    <div class="card shadow mb-4">
						...
						<div class="card-body">
                            <form action="/{{$tahun->tahun}}-tagihan-{{$bulan->id}}/store" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="total_tagihan" name="total_tagihan" placeholder="Masukkan Total Tagihan" required>
                                    @error('total_tagihan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
