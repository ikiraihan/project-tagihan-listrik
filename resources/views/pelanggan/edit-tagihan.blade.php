            ...
            <div class="row justify">
                <div class="col-xl-20 col-lg-12 col-md-9">
                    <div class="card shadow mb-4">
						...
						<div class="card-body">
                            <form action="/pelanggan-{{$pelanggan->id}}-detail-{{$tahun}}/tagihan/update/{{$tagihan->id}}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="bulan" name="bulan">
                                        <option value="{{$tagihan->bulan}}">{{$tagihan->bulan}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="kwh" name="kwh" placeholder="Masukkan Jumlah KWH" value="{{ $tagihan->KWH }}" required>
                                    @error('kwh')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kelas_tarif" name="kelas_tarif" placeholder="Masukkan Kelas Tarif" value="{{ $tagihan->kelas_tarif }}"  required>
                                    @error('kelas_tarif')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="total_tagihan" name="total_tagihan" placeholder="Masukkan Total Tagihan" value="{{ $tagihan->total_tagihan }}"  required>
                                    @error('total_tagihan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
